...
```bash
curl -X POST "https://nknx.org/api/auth/register"     -d "email"="A7VUMN5bIocklIEv" \
    -d "name"="NsIcF6PjZCoRI6pi" \
    -d "password"="v4xoHH3vIPc9QubD" 
```
...
var settings = {
    ...
    "method": "POST",
    "data": {
        "email": "A7VUMN5bIocklIEv",
        "name": "NsIcF6PjZCoRI6pi",
        "password": "v4xoHH3vIPc9QubD"
    },
    "headers": {
    }
}
...
```bash
curl -X POST "https://nknx.org/api/auth/reset/{token}"     -d "password"="dAQ4LzZqHnuJXvzS" 
```
...
```bash
curl -X POST "https://nknx.org/api/auth/reset"     -d "email"="dv6TkDnNKKPUkjvY" 
```
...
```bash
curl -X POST "https://nknx.org/api/auth/login"     -d "email"="vKC8DoDjZWe6hAiq" \
    -d "password"="9TQ7AW8TTZX6I5Gj" 
```
...
var settings = {
    ...
    "method": "POST",
    "data": {
        "email": "vKC8DoDjZWe6hAiq",
        "password": "9TQ7AW8TTZX6I5Gj"
    },
    "headers": {
    }
}
...
```bash
curl -X POST "https://nknx.org/api/walletAddresses"     -d "address"="d3LNuudXsjM854H0" \
    -d "label"="nknx" 
```
